// Display a integer 4bytes Trace Header values from SEGY-File
// By AJ Ovalles, 2016
// Made in Venezuela
...
int main(int argc,char* argv[]) {
  ...
  if (argv[1] == NULL){
    printf("Syntax: >> Extract_IntHeader filename maxTraceNumber 3600+ByteToExtract\n");
  }
  else{
  ...
  while (trc < maxtrc){ //iterar hasta el maximo numero de traces
    ...
    seq_line = be32toh(seq_line); // Ajusta el endiann del file al del host  
